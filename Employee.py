    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                admLabel = Label(product_page, text='EMPLOYEE', font=('yu gothic ui', 18, 'bold'), fg='#ffc329',
                                 bg='#f6f6f9')
                admLabel.place(x=1120, y=11)
                ...
                help_button = Button(product_page, text='Help', bg='#f6f6f9', font=("", 13, "bold"), bd=0, fg='#7a7a7a',
                                     cursor='hand2', activebackground='#fd6a36', activeforeground='#7a7a7a',
                                     command=help)
                ...
                def update():
                    db.execute_update(
                        "UPDATE Coffee_Category SET coffee_name=?, type=?, discount=?, in_stock=?, coffee_price=? WHERE coffee_id=?",
                ...
                scrollbary.place(relx=0.973, rely=0.323, width=25, height=412)
                scrollbarx.place(relx=0.282, rely=0.929, width=950, height=25)
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                admLabel = Label(biller, text='EMPLOYEE', font=('yu gothic ui', 18, 'bold'), fg='#ffc329', bg='#f6f6f9')
                admLabel.place(x=1170, y=11)
                ...
                help_button = Button(biller, text='Help', bg='#f6f6f9', font=("", 13, "bold"), bd=0, fg='#7a7a7a',
                                     cursor='hand2', activebackground='#fd6a36', activeforeground='#7a7a7a',
                                     command=help)
                help_button.place(x=360, y=15)
                ...
                purchaseFrame.place(x=690, y=80, width=100, height=80)
                ...
                productsFrame.place(x=870, y=80, width=100, height=80)
                ...
                photo = ImageTk.PhotoImage(productsIcon)
                products = Button(productsFrame, image=photo, bg='#ffffff', width=93, height=52, bd=0, cursor='hand2',
                                  activebackground="#ffffff", command=lambda: product_window(self))
                products.image = photo
                products.place(x=0, y=22)
                ...
                #self.message.place(relx=0.869, rely=0.019, width=166, height=30)
                ...
                self.button6.configure(borderwidth="0")
                self.button6.configure(text="""Exit""")
                self.button6.configure(command=exitt2)
                ...
                db.execute_query(find_category)
                result1 = db.fetchall()
                cat = []
            ...
            def get_category(self, Event):
                ...
                db.execute_query(find_subcat, [self.combo1.get()])
                result2 = db.fetchall()
                subcat = []
            ...
            def get_subcat(self, Event):
                ...
                db.execute_query(find_product, [self.combo1.get(), self.combo2.get()])
                result3 = db.fetchall()
                pro = []
            ...
            def show_qty(self, Event):
                ...
                db.execute_query(find_qty, [product_name])
                results = db.fetchone()
            ...
            def add_to_cart(self):
                ...
                if strr.find('Total') == -1:
                    ...
                    if (product_name != ""):
                        ...
                        db.execute_query(find_mrp, [product_name])
                        results = db.fetchall()
                        stock = results[0][1]
                        mrp = results[0][0]
            ...
            def search_bill(self):
                ...
                db.execute_query(find_bill, [cust_search_bill.get().rstrip()])
                results = db.fetchall()
                if results:
                    # self.clear_bill()
                    self.wel_bill()
