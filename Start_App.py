...
root = Tk()
# root.resizable(0, 0)
# image = PhotoImage(file='images/CoffeeShop-brand-logo.png')
...
welcome_label = Label(text='WELCOME TO GARAGE COFFEE SHOP', bg='#fd6a36', font=("yu gothic ui", 15, "bold"), fg='black')
