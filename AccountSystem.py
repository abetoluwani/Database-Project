...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        brand_name = Label(landing_page, text='GARAGE COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("yu gothic ui", 15, "bold"))
        ...
        brand_name = Label(sign_in, text='GARAGE COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        ...
        brand_name = Label(sign_up, text='GARAGE COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)
